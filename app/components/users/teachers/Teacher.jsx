  ...
  return (
    <div className="my-20">
        ...
        <div className="grid grid-flow-col gap-3 bg-gray-300 px-4 p-2">
            ...
            <button onClick={ () => setActive(<Students />) } className="text-center bg-blue-300 border-blue-600 border-2 rounded-lg px-1 hover:bg-blue-500 hover:text-white">
                Estudiantes
            </button>
            ...
            <button onClick={ () => setActive(<CreateBlog />) } className="text-center bg-blue-300 border-blue-600 border-2 rounded-lg px-1 hover:bg-blue-500 hover:text-white">
                Blog
            </button>
        </div>
        <div className="my-4">

...
export const HomeComponent = () => {
  return (
    <div className="flex-grow flex flex-col lg:flex-row lg:overflow-hidden">
        <aside className="w-full lg:w-80 flex-shrink-0 overflow-y-auto bg-slate-800 lg:fixed mt-14 h-full">
          <AsideHome />
        </aside>

        <main className="flex-grow flex flex-col pt-4 lg:pt-0">
          <h2 className="text-white text-2xl font-bold text-center lg:text-center lg:ml-80 pt-4 lg:pt-24 mb-4">
